...
logfile = r'update_monsterindia_profile_{}.log'.format(time.strftime('%Y_%m_%d_%H.%M.%S'))
updateimage = r'update_monsterindia_profile_{}.png'.format(time.strftime('%Y_%m_%d_%H.%M.%S'))    
...
try:
    ...
    config.read('monsterindiaconfig.ini')
